...
FROM cities JOIN countries ON country_id = countries.id 
...
/* //////////////// */
SELECT name AS pais, language, percentage FROM languages 
JOIN countries ON country_id = countries.id
WHERE percentage > 89
ORDER BY percentage DESC;
/* //////////////// */
...
una esperanza de vida superior a 75 años? */
/* //////////////// */
...
de Buenos Aires y tener una población superior a 500,000? 
